...
category: 'anti-swear',run: async (client, message, args) => {
    ...
    if (!word) {
      ...
      .setFooter(message.author.tag + " | made by cwkhan", message.author.displayAvatarURL())
    ...
    if (pog) {
            ...
            let No = new Discord.MessageEmbed()
                ...
                No.setColor("#FF0000")
                No.setFooter(message.guild.name + " | made by cwkhan", message.guild.iconURL());
            ...
            let embed = new Discord.MessageEmbed()
                ...
                embed.setFooter(message.guild.name + " | made by cwkhan", message.guild.iconURL());
